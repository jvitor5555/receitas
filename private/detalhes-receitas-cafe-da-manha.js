...
import { receitasCafeDaManha } from '../data/dados-receitas-cafe-da-manha';

export default function DetalhesReceitasCafeDaManha({ route }) {
    const { id } = route.params;

    const receita = receitasCafeDaManha.find(item => item.id === Number(id));
