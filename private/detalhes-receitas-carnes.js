...
import { receitasCarnes } from '../data/dados-receitas-carnes';

export default function DetalhesReceitasCarnes({ route }) {
    const { id } = route.params;

    const receita = receitasCarnes.find(item => item.id === Number(id));
