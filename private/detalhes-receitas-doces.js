...
import { receitasDoces } from '../data/dados-receitas-doces';

export default function DetalhesReceitasDoces({ route }) {
    const { id } = route.params;

    const receita = receitasDoces.find(item => item.id === Number(id));
