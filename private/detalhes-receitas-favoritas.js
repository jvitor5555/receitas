...
import { receitasFavoritas } from '../data/dados-receitas-favoritas';

export default function DetalhesReceitaFavoritas({ route }) {
    const { id } = route.params;

    const receita = receitasFavoritas.find(item => item.id === Number(id));
