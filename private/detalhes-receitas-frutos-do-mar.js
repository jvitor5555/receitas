...
import { receitasFrutosDoMar } from '../data/dados-receitas-frutos-do-mar';

export default function DetalhesReceitasFrutosDoMar({ route }) {

    const { id } = route.params;

    const receita = receitasFrutosDoMar.find(item => item.id === Number(id));
