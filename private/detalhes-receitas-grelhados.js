...
import { receitasGrelhados } from '../data/dados-receitas-grelhados';//

export default function DetalhesReceitasGrelhados({ route }) {
    const { id } = route.params;

    const receita = receitasGrelhados.find(item => item.id === Number(id)); //
