...
import { receitasMassas } from '../data/dados-receitas-massas';//

export default function DetalhesReceitasMassas({ route }) {
    const { id } = route.params;

    const receita = receitasMassas.find(item => item.id === Number(id));//
