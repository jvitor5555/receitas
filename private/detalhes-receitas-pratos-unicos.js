...
import { receitasPratosUnicos } from '../data/dados-receitas-pratos-unicos';

export default function DetalhesReceitasPratosUnicos({ route }) {
    const { id } = route.params;

    const receita = receitasPratosUnicos.find(item => item.id === Number(id));
