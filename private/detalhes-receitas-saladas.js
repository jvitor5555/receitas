...
import { receitasSaladas } from '../data/dados-receitas-saladas';//

export default function DetalhesReceitasSaladas({ route }) {
    const { id } = route.params;

    const receita = receitasSaladas.find(item => item.id === Number(id));//
