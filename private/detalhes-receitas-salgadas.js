...
import { receitasSalgados } from '../data/dados-receitas-salgadas';

export default function DetalhesReceitaSalgadas({ route }) {
    const { id } = route.params;

    const receita = receitasSalgados.find(item => item.id === Number(id));
