...
import { receitasSopas } from '../data/dados-receitas-sopas-caldos';//

export default function DetalhesReceitasSopasCaldos({ route }) {
    const { id } = route.params;

    const receita = receitasSopas.find(item => item.id === Number(id));//
